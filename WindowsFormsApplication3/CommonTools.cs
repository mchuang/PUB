...
namespace PUB {
    public class CommonTools {
        ...
        public class Read {
            ...
            public Read(int parkID, string spaceID,  DateTime readDate, int gasValue, int eleValue, int watValue, int id = -1) {
                this.readId = id;
                this.parkID = parkID;
        ...
        public class Tier {
            ...
            public char season { set; get; }
            public decimal[] rates;

            public Tier(char charge, char season, String description) {
                this.chargeType = charge;
                this.status = description;
                this.season = season;
                rates = new decimal[] { 0.0M, 0.0M, 0.0M, 0.0M, 0.0M };
            }
            ...
            public override bool Equals(Object obj) {
                Tier set = (Tier)obj;
                return set.chargeType == this.chargeType && this.season == set.season && this.status == set.status;
            }
        }
        ...
        public class Surcharge {
            ...
            public Surcharge(String description, String status, int usage, decimal rate) {
            ...
            public override bool Equals(Object obj) {
                ...
                return set.info == this.info && this.status == set.status;
            }
        }
        ...
        public static decimal nextAllowance(decimal percentage, decimal allowance) {
            return (decimal)0.0;
        }
